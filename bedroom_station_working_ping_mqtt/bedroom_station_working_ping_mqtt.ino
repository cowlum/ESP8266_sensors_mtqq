...
WiFiClient aidansroom;
PubSubClient client(aidansroom);
...
void sendpubsub(){
 if((long)(millis() - rolltime) >= 0) {
      char tempString[8];
      temperaturebme2 = dht.readTemperature();
      ...
      client.connect("aidansroom");
      delay(100);
          client.publish("aidansroom/temperature", tempString);
          Serial.println(tempString);
          client.publish("aidansroom/pressure", presString);
          Serial.println(presString);
          client.publish("aidansroom/humidity", humidString);
...
String SendHTML(float temperature, float humidity, float pressure, float altitude) {
  ...
  ptr += "<html>";
  ptr += "<head>";
  ptr += "<title>Bedroom Weather Station</title>";
  ...
  ptr += "</head>";
  ptr += "<body>";
  ptr += "<h1>Bedroom Weather Station</h1>";
  ...
  ptr += "<span class='superscript'>&deg;C -1</span></div>";
  ptr += "</div>";
  ptr += "<div class='data humidity'>";
  ptr += "<div class='side-by-side icon'>";
  ptr += "<svg enable-background='new 0 0 29.235 40.64'height=40.64px id=Layer_1 version=1.1 viewBox='0 0 29.235 40.64'width=29.235px x=0px y=0px><path d='M14.618,0C14.618,0,0,17.95,0,26.022C0,34.096,6.544,40.64,14.618,40.64s14.617-6.544,14.617-14.617";
  ...
  ptr += "s2.257,1.01,2.257,2.257V39.73C13.934,40.597,15.302,42.554,15.302,44.833z'fill=#F29C21 /></g></svg>";
  ptr += "</div>";
  ptr += "<div class='side-by-side text'>Temperature DHT sensor</div>";
  ptr += "<div class='side-by-side reading'>";
  ptr += (float)altitude;
