...
void sendpubsub(){
 if((long)(millis() - rolltime) >= 0) {
      ...
      delay(100);
          client.publish("outside/temperature", tempString);
          Serial.println(tempString);
          client.publish("outside/pressure", presString);
          Serial.println(presString);
          client.publish("outside/humidity", humidString);
...
String SendHTML(float temperature, float humidity, float pressure, float altitude) {
  ...
  ptr += "<html>";
  ptr += "<head>";
  ptr += "<title>outside Weather Station</title>";
  ...
  ptr += "</head>";
  ptr += "<body>";
  ptr += "<h1>outside weather station</h1>";
